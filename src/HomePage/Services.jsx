  ...
  return (
    <div className='text-center'>
        <div className='bg-gray-50 py-10'>
            <h2 className='uppercase py-2 sm:mt-3'>
                Our Services
            </h2>
        ...
        <div className='flex justify-center'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4 max-w-6xl'>
                <Link to='/LocalMove' >
                    <div className='bg-gray-50 h-full rounded-md mt-2 py-2 shadow-md active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] hover:cursor-pointer'>
                        <img
                            src={firstpic} 
                            alt='first'
                            className='px-4'
                ...
                <Link to='/LocalMove'>
                    <div className='bg-gray-50 rounded-md mt-2 py-2 shadow-md active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] hover:cursor-pointer'>
                        <img
                            src={SecPic} 
                            alt='second'
                            className=' px-4'
